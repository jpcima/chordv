...
QT_MOC_LITERAL(1, 12, 15), // "ImageSelelected"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "Image"
QT_MOC_LITERAL(4, 35, 8) // "SetImage"

    },
    "ImageButton\0ImageSelelected\0\0Image\0"
    "SetImage"
};
...
void ImageButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ImageSelelected((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->SetImage((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageButton::ImageSelelected)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ImageButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_ImageButton.data,
...
// SIGNAL 0
void ImageButton::ImageSelelected(QString _t1)
{
