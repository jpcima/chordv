...
QT_MOC_LITERAL(1, 10, 7), // "PDFMade"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4) // "file"

    },
    "Processor\0PDFMade\0\0file"
};
...
void Processor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PDFMade((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Processor::PDFMade)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Processor::PDFMade(QString _t1)
{
