...
# Project:  chordV.pro
# Template: app
# Command: /home/gilles/Qt/5.9/gcc_64/bin/qmake -o Makefile chordV.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/gilles/Qt/5.9/gcc_64/lib
...
build/moc/moc_predefs.h: ../../Qt/5.9/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -Wall -W -dM -E -o build/moc/moc_predefs.h ../../Qt/5.9/gcc_64/mkspecs/features/data/dummy.cpp
