...
INCPATH       = -I. -isystem /usr/local/include -Iinclude -I../../Qt/5.9/gcc_64/include -I../../Qt/5.9/gcc_64/include/QtWidgets -I../../Qt/5.9/gcc_64/include/QtGui -I../../Qt/5.9/gcc_64/include/QtSql -I../../Qt/5.9/gcc_64/include/QtCore -Ibuild/moc -isystem /usr/include/libdrm -Ibuild/ui -I../../Qt/5.9/gcc_64/mkspecs/linux-g++
...
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/usr/lib -lpodofo -lfreetype -lfontconfig -lidn -ljpeg -ltiff -lz -lm -lpng -lcrypto -lssl -L/home/gilles/Qt/5.9/gcc_64/lib -lQt5Widgets -lQt5Gui -lQt5Sql -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/main.cpp \
		...
		src/formeditor.cpp build/rcc/qrc_resources.cpp \
...
DIST          = Example/deuxdisques.png \
		...
		include/formeditor.h src/main.cpp \
		src/mainwindow.cpp \
		src/util.cpp \
		src/formconfig.cpp \
		src/lyricsconfig.cpp \
