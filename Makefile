...
SOURCES       = src/main.cpp \
		...
		src/textedit.cpp \
		src/dialogdocumentation.cpp build/rcc/qrc_resources.cpp \
...
DIST          = Example/deuxdisques.png \
		...
		include/textedit.h \
		include/dialogdocumentation.h src/main.cpp \
		src/mainwindow.cpp \
		src/util.cpp \
		src/formconfig.cpp \
		src/lyricsconfig.cpp \
